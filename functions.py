    ...
    if key_name in multiple_values_keys:
        ...
        if value in user_data[key_name]:
            ...
            if key_name in ["like_movie", "dislike_movie"]:
                ...
                for genre in genres:
                    user_data[genre_key][genre] = user_data[genre_key].get(genre, 0) + (1 if key_name == "like_movie" else -1)
...
def get_recommendation():
    ...
    with open("user_info.json", 'r',encoding="UTF-8") as file:
        ...
        like_genre = [genre for genre, weight in like_genre_value.items() if weight != 0]
        dislike_genre=list(dislike_genre_value.keys())
        like_keywords=user_info['like_genres']
        dislike_keywords=user_info['dislike_genres']
    ...
    if not old_movies:
        ...
        params = valid_ratings + ['2022-01-01']
    else:

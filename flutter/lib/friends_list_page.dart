...
class _FriendsListPageState extends State<FriendsListPage> with TickerProviderStateMixin {
  final List<Friend> recommendedFriends = [
    Friend('이다미', 'assets/images/profile/leedami.png', '요즘 볼 영화 없지? 같이 영화 얘기할래? 너의 취향에 맞는 영화 찾아줄게. 우리 같이 즐기자!'),
    Friend('고양이', 'assets/images/profile/cat.jpg', '뭘 봐\n 말하는 고양이 처음 봐?'),
    Friend('영어쌤', 'assets/images/profile/englishteacher.jpg', '안녕! 여러분의 영어 실력을 함께 키워갈 선생님이에요. 우리 같이 즐겁게 영어 배워봐요!'),
  ];

  final List<Friend> newFriends = [
    Friend('한플리', 'assets/images/profile/music.png', '너 또 그 음악 듣고 있냐? 내가 세련된 음악 추천해줄게. 내 추천 믿고 들어봐. 네 귀가 호강할 거야!'),
    Friend('노스트라', 'assets/images/profile/tarot.jpg', '미래가 궁금해? 신비로운 타로 카드가 답을 줄 거야. 나와 함께 운명의 비밀을 밝혀보자.'),
    Friend('김앤장', 'assets/images/profile/lawyer.jpg', '안녕하세요. 당신의 든든한 법률 파트너입니다. 복잡한 법적 문제, 제가 깔끔하게 해결해드릴게요.'),
  ];

  final List<Friend> hotFriends = [
    Friend('최아나', 'assets/images/profile/announcer.jpg', '안녕하세요! 깔끔하고 정확한 뉴스 아나운서 최아나입니다. 가장 빠르고 신뢰할 수 있는 소식을 전해드릴게요.'),
    Friend('임국종', 'assets/images/profile/doctor.jpg', '안녕하세요, 환자분. 어디가 불편하신가요? 건강을 위해 최선을 다해 도와드리겠습니다'),
    Friend('백다빈', 'assets/images/profile/shop.jpg', '꼴이 그게 뭐야? 진짜 감 떨어졌네. 최신 쇼핑 트렌드? 나한테 배워.'),
  ];
  ...
  void dispose() {
    ...
    hotFriends.forEach((friend) => friend.infoController.dispose());
          ...
          SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                _buildHorizontalFriendList(hotFriends, '요즘 뜨는 친구'),
              ],
            ),
          ),
          SingleChildScrollView(
